...
const Footer = () => {
  return (
    <footer className="border-t bg-purple-600 py-8">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0">
            <h2 className="text-xl font-bold">Hire Talents</h2>
          ...
          <div className="flex space-x-4 mt-4 md:mt-0">
            ...
            <a href=" https://x.com/DeepU_18?t=mPgd7C61EBUOS4wb8CfO0Q&s=08" className="hover:text-gray-400" aria-label="Twitter">
            ...
            <a href="www.linkedin.com/in/dêëpak-yadav-b05944217" className="hover:text-gray-400" aria-label="LinkedIn">
